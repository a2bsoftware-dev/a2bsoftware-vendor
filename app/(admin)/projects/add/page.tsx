...
export default function AddEditProjectPage() {
  ...
  // distinct from the client's own survey_link above, and from the per-vendor
  // links generated on the Supplier Allocations screen. This is the one meant
  // to actually be handed to vendors; only buildable once the project has a
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="border-zinc-200 shadow-sm bg-white dark:bg-zinc-900">
          ...
          <CardContent className="pt-6 pb-6">
            ...
            {/* Vendor app never shows the client's real Survey Link/Test Link -
                only the auto-generated, vendor-safe Main Portal Link below
                (the backend also blanks surveyLink/surveyTestLink for vendor
                accounts anyway - see ProjectService.redactSurveyLink). */}
            {project_id && (
              <div className="mt-6 space-y-1.5">
                ...
                <p className="text-[11px] text-zinc-400">
                  Auto-generated by this dashboard - use this link to send respondent traffic.
                </p>
