              ...
              <CardContent className="pt-4 pb-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {ACCESS_RIGHTS_MODULES.map((module) => {
                    ...
                    // Admin always has every module by default (enforced server-side,
                    // independent of what's saved here) - locked so it can't be edited
                    // into a partial set that would lock the admin account out.
