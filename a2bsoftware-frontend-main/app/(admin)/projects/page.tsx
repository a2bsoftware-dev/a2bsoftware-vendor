...
export default function ProjectsPage() {
  ...
  // Fetch projects list
  const loadProjects = async (targetPage = page, targetLimit = limit) => {
    setLoading(true);
    try {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="space-y-1">
              ...
              >
                ...
                {filterOptions.statusOptions.map((opt: any) => (
            ...
            <div className="space-y-1">
              ...
              >
                ...
                {filterOptions.clients.map((cl: any) => (
            ...
            <div className="space-y-1">
              ...
              >
                ...
                {filterOptions.projectManagers.map((pm: any) => (
            ...
            <div className="space-y-1">
              ...
              >
                ...
                {filterOptions.salesManagers.map((sm: any) => (
                          ...
                          {project.surveyLink ? (
                            <div className="flex items-center gap-1">
                              ...
                              <Button
                                variant="ghost"
                                size="icon"
                                onClick={() => handleCopySurveyLink(project.surveyLink, project.id)}
